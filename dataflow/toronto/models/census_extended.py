...
class FactCensusExtended(Base):
    ...
    occupied_private_dwellings: Mapped[int | None] = mapped_column(
        Integer, nullable=True
    )
    avg_household_size: Mapped[float | None] = mapped_column(
    ...
    pct_suitable_housing: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    avg_shelter_cost_owner: Mapped[float | None] = mapped_column(
        Numeric(10, 2), nullable=True
    )
    avg_shelter_cost_renter: Mapped[float | None] = mapped_column(
        Numeric(10, 2), nullable=True
    )
    pct_shelter_cost_30pct: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )

    # Education
    pct_no_certificate: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    ...
    # Labour force
    participation_rate: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    ...
    pct_employed_full_time: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )

    # Income
    median_after_tax_income: Mapped[float | None] = mapped_column(
        Numeric(12, 2), nullable=True
    )
    median_employment_income: Mapped[float | None] = mapped_column(
        Numeric(12, 2), nullable=True
    )
    lico_at_rate: Mapped[float | None] = mapped_column(Numeric(5, 2), nullable=True)
    market_basket_measure_rate: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )

    # Diversity / immigration
    pct_immigrants: Mapped[float | None] = mapped_column(Numeric(5, 2), nullable=True)
    pct_recent_immigrants: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_visible_minority: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    ...
    pct_neither_official_lang: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    ...
    pct_movers_within_city: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_movers_from_other_city: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )

    # Commuting / transport
    pct_car_commuters: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_transit_commuters: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_active_commuters: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_work_from_home: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )

    # Additional indicators
    median_age: Mapped[float | None] = mapped_column(Numeric(5, 2), nullable=True)
    pct_lone_parent_families: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    avg_number_of_children: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_dwellings_in_need_of_repair: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_unaffordable_housing: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_overcrowded_housing: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    median_commute_minutes: Mapped[float | None] = mapped_column(
        Numeric(5, 1), nullable=True
    )
    pct_postsecondary: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_management_occupation: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_business_finance_admin: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_service_sector: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
    pct_trades_transport: Mapped[float | None] = mapped_column(
        Numeric(5, 2), nullable=True
    )
